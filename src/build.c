...
/* Experience Added Listy */ // I don't give a shit - Smoo (try not taking credit for the smallest things in existance)
	if ( !str_cmp( arg2, "exp") )
	{/*
		if (value < 1 || value > 99000000)
		{
			...
			return;
		}*///why the fuck would you put restrictions, imms are GODS they can do ANYTHING:P up to INT_MAX .. hehehehe
		victim->exp = value;
		return;
	}
...
str_cmp(argument, "---head") && str_cmp(argument, "atexit"))
    {
