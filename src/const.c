 ...
 */
    ...
    {
	"focus",		  12,
	spell_focus,		  TAR_CHAR_DEFENSIVE,    POS_STANDING,
	NULL,			SLOT(205),      5,      12,
	"",			"You no longer feel focused."
    },
    {
        "forcebless",             12,
 ...
 */
    ...
    {
	"preserve",		50, // taken out, due to druid staffs
	...
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"&YSharp Golden Slivers#n",""
    },
    {
	"white magic",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(554),	 100,	12,
	"",		"&WYou feel god's touch fade away and you want sumore!#n"
    },
    {
	"ram",		99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	...
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Wind Slash",	"&CYou feel the power of the wind fade away.."
    },
    {	"elf fire",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"Elven Fire",	"&RYour blessing of the elven fire fades.."
    },
    {	"Rage",		99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	...
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	0,
	"&DH&Yi&Dg&Yh&DS&Yt&Da&Yr#n", ""
    },
    {	"Tsunaki",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	NULL,			SLOT(0),	0,	PULSE_VIOLENCE/2,
	"rib jab",	""
    },
    {	"yashakin",	99,
	spell_null,		TAR_IGNORE,		POS_STANDING,
	...
	NULL,			SLOT(92),	300,	3,
	"berry",		"You may now make a Mr Berry.", CLASS_DRUID
    },

    {
	"Angel Breath",		5,
	spell_angel_breath,	TAR_CHAR_DEFENSIVE, POS_STANDING,
	NULL,			SLOT( 22),	 100,	8,
	"",			"You feel tired as your angel breath fades away..", CLASS_DRUID
    },

    {
	"Dragon Breath",	5,
	spell_dragon_breath,	TAR_CHAR_DEFENSIVE, POS_STANDING,
	NULL,			SLOT( 23),	 150,	8,
	"",			"You feel weak as you loose all that power..", CLASS_DRUID
    },

    {
	"Shillelagh",		5,
	spell_shillelagh,	TAR_CHAR_DEFENSIVE, POS_RESTING,
	NULL,			SLOT( 23),	 100,	4,
	"",			"(This spell creates a druid weapon)", CLASS_DRUID
    },

    {
	"Infest",		5,
	spell_infest,	        TAR_CHAR_OFFENSIVE,POS_RESTING,
	NULL,			SLOT(92),	200,	5,
	"infest",		"Ooh, a berry!", CLASS_DRUID
    },

    {
	"thorns",		100,
	spell_null,	        TAR_IGNORE,	POS_RESTING,
	&gsn_thorns,		SLOT(93),	0,	0,
	"Blistering Thorns",	"!Thorns!", CLASS_DRUID
    },   

    {
	"Reward",		5,
	spell_reward,		TAR_IGNORE, POS_STANDING,
	NULL,			SLOT( 23),	 100,	4,
	"",			"", CLASS_DRUID
    },
    ...
    {
	"Redeem",		5,
	spell_redeem,		TAR_IGNORE, POS_STANDING,
	NULL,			SLOT( 23),	 100,	4,
	"",			"", CLASS_DRUID
    },
    ...
    {
	"Phoenix Sight",	5,
	spell_phoenix_sight,	TAR_CHAR_DEFENSIVE,	POS_RESTING,
	NULL,		SLOT(0),		100,	6,
	"",	"Your eyes dim, and you begin to feel blind.", CLASS_DRUID
    },

    {
	"Spy",			5,
	spell_spy,		TAR_IGNORE,		POS_RESTING,
	NULL,		SLOT(0),		100,	6,
	"",	"", CLASS_DRUID
    },
    {
	"lend",			5,
	spell_lend,		TAR_CHAR_DEFENSIVE,	POS_RESTING,
	NULL,		SLOT(0),		100,	6,
	"",	"", CLASS_DRUID
    },
    {
	"shiroken",		99,
	spell_null,			0,			0,
	&gsn_shiroken,		SLOT(0),		0,	0,
	"poison-blade shiroken",	""
    },
    {
	"&s&MS&Cm&Woo&t",	12,
	spell_smoo,		TAR_CHAR_DEFENSIVE,	POS_DEAD,
	NULL,			SLOT(0),	0,	0,
	"","SMOOOOOO! SMOOOOOO!!!"
    },
    {   "incubic",		99,
