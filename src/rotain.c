...

{
	...
	send_to_char("*************************************************\n\r", ch);
	stc("Midnight Realities 2.5 by Smoo, Jeremy\n\r", ch);
	stc("Building credits to Nightfall AKA Nemesis\n\r", ch);
	stc("Thanks to berelain for a free server in the beginning.\n\r", ch);
	stc("\n\r\n\rMidnight Dreams 1.0 by Smoo Berelain Neka Jace\n\r", ch);
	stc("Building credits and severe thanks go to Neka for
\rkeeping it up whenever bryantos would have shut it down.\n\r", ch);
	stc("Credits for being the crappiest owner go to bryantos, he
\rwas NEVER on.\n\r\n\r", ch);
	...
	send_to_char("*************************************************\n\r", ch);
	         stc("By the license attached to Midnight Realities 2.5 
\rand above, this command may not be removed, and the 
\roriginal text may not be edited. Appending your own 
\rcredits is allowed.\n\r", ch);
   return;
}
