...
const struct form_type form_data [MAX_FORMS] =
{
    ...
    {"dolphin"," the dolphin",    -5,     -5,     -10,    200,    FALSE, 
    ...
    {"spider"," the spider", 0,   0,      0,      0,      FALSE, 
    ...
    {"cockroach"," the cockroach",  -20,    -20,    60,     0,      TRUE, 
	SIZE_TINY,FALSE,FALSE,FALSE,0,0,"","",50,1,"","the cockroach",FALSE},
    {"rabbit"," the rabbit",       -20,    -20,    20,     -10,    
    ...
    {"frog"," the frog",       -20,    -20,    20,     -10,    TRUE, 
    ...
    {"hawk"," the hawk",  20,     20,     -80,    0,    FALSE, SIZE_SMALL,
	FALSE,TRUE,FALSE,2,1,"","",100,3,"A small hawk it fluttering about","a tiny hawk",FALSE},
    {"werewolf"," the werewolf",  60,     60,     -40,    0,    FALSE, SIZE_MEDIUM,
	FALSE,FALSE,TRUE,500,60,"growl","bounds",140,-1,
	"A ravenous half-man, half-wolf is standing here.", "a savage werewolf",TRUE},
    {"fox"," the fox",  -20,     -20,     -40,    0,    FALSE, SIZE_SMALL,
	FALSE,FALSE,FALSE,20,1,"growl","bounds",80,3,
	"A small brown fox is here.", "a small fox",FALSE},
    {"wyvern"," the wyvern",  50,     70,     -40,    0,    FALSE, SIZE_LARGE,
...
const struct clanrank_type clanrank [9][14] =
{
	...
	{       " Death Bringer>",       102   ,"Death Bringer","Death Bringer"  },
	{       " Death Bringer>",       112   ,"Death Bringer","Death Bringer"  }
    }
};
...
{
    if (dragtype == DRAGON_RED) return "&RRed#n";
    else if (dragtype == DRAGON_WHITE) return "&WWhite#n";
    else if (dragtype == DRAGON_BLACK) return "Black";
    else if (dragtype == DRAGON_GREEN) return "&GGreen#n";
    else if (dragtype == DRAGON_BLUE) return "&BBlue#n";
    else if (dragtype == DRAGON_SILVER) return "&CSilver#n";
    else if (dragtype == DRAGON_GOLD) return "&YGold#n";
