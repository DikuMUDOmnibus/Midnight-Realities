...
int can_interpret (CHAR_DATA *ch, int cmd)
{
    ...
    if (cmd_table[cmd].level > get_trust(ch) && (is_pure(cmd_table[cmd].name,find_kingdom(ch->kingdom)?find_kingdom(ch->kingdom)->Skills:" "))) return 0;
...
act("$p appears in your hands in a flash of light.",ch,obj,NULL,TO_CHAR);
...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "tap",		do_tap,			POS_RESTING,	0, LOG_NORMAL},
    { "topscores",	do_tops,		POS_DEAD,	0, LOG_NORMAL},
    ...
    { "glorify",	do_glorify,		POS_DEAD,	0, LOG_NORMAL},
    { "crecall",	do_crecall,		POS_RESTING,	0, LOG_NORMAL},
    ...
    { "helpdump",	do_helpdump,		POS_DEAD,	12,  LOG_NORMAL, 0,0,0	},
    ...
    { "dice",		do_dice,		POS_DEAD,		0, LOG_NORMAL},
    { "exp",        do_weaplist,	POS_FIGHTING,    0,  LOG_NORMAL, 0,0,0},
    { "level",      do_weaplist,	POS_DEAD,    0,  LOG_NORMAL, 0,0,0},
    ...
    { "bloodline",	do_bloodline,	POS_STANDING,	 1,  LOG_NORMAL, 0,0,0 },
    ...
    { "spouse",		do_spouse,		POS_DEAD,		0, LOG_NORMAL},
{"chandisable",		do_chandisable,		POS_DEAD,		12, LOG_ALWAYS},
    /*
     * Communication commands.
     */
    { "answer",		do_answer,		POS_SLEEPING,	 0,  LOG_NORMAL, 0,0,0	},
    { "chat",		do_chat,		POS_DEAD,	 	 0,  LOG_NORMAL, 0,0,0	},
// I keep forgetting to type the first word of these commands (?)
    { "hat",		do_chat,		POS_DEAD,	 	 0,  LOG_NORMAL, 0,0,0	},
    { "ay",		do_say,		POS_DEAD,	 	 0,  LOG_NORMAL, 0,0,0	},
//
    ...
    { "gemote",		do_gemote,		POS_DEAD,	 2, LOG_NORMAL, 0,0,0	},
...
0,0,0	},
    ...
    { "generation", do_generation,	POS_STANDING,	9,	LOG_ALWAYS, 0,0,0 },
    { "class",      do_class,		POS_STANDING,	8,	LOG_ALWAYS, 0,0,0 },
    ...
    { "ban",		do_ban,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0	},
    /* kingdom commands - Smoo */
    { "kcontrol",	do_kcontrol,		POS_SLEEPING,	2,   LOG_NORMAL},
    { "druggies",	do_druggies,		POS_SLEEPING,	2,   LOG_NORMAL },
    { "deus",	do_eternity,		POS_SLEEPING,	2,   LOG_NORMAL},
      { "kgate",	do_kgate,	POS_STANDING,	99, LOG_NORMAL},
    { "spiritlords",	do_spiritlords,		POS_SLEEPING,	2,   LOG_NORMAL},
    { "banish",		do_banish,		POS_STANDING,	2,   LOG_NORMAL },
    { "introduce",	do_introduce,		POS_STANDING,	2,   LOG_NORMAL },
    { "kingedit",	do_kingedit,		POS_DEAD,	10,  LOG_NORMAL},
    { "klist",	do_klist,		POS_DEAD,	0, LOG_NORMAL},
    { "kstat",		do_kstat,		POS_SLEEPING,	0, LOG_NORMAL},
    /* bounty list */
    { "blist",		do_blist,		POS_SLEEPING,	0, LOG_NORMAL},
    ...
    { "callundead",	do_undeadcall,	POS_STANDING,	3,	LOG_NORMAL, 0,0,0},
    ...
    { "finger",		do_finger,		POS_DEAD,	 0,  LOG_NORMAL, 0,0,0	},
    { "checkpk",	do_checkpk,		POS_DEAD, 9,LOG_NORMAL},
...
//3,  LOG_ALWAYS, 0,0,0	},
    ...
    { "empower",	do_empower,		POS_STANDING,	3,  LOG_NORMAL, 0, 0, 0}, 

    { "gamble",		do_gamble,		POS_SLEEPING, 1, LOG_NORMAL},
    { "break_game",	do_break_game,		POS_DEAD,	1, LOG_NORMAL},
    { "breakgame",	do_break_game,		POS_DEAD,	1, LOG_NORMAL},
   ...
   { "propose",	do_propose,		POS_STANDING,	 2,  LOG_NORMAL, 0,0,0	},
    ...
    { "vembrace",    do_embrace,		POS_STANDING,      3,  LOG_NORMAL, 8,0,0 },
    ...
    { "estimate",      do_estimate,		POS_SITTING,         0,  LOG_NORMAL, 0,0,0  },
    { "techo",         do_trivia,       POS_DEAD,                7,
LOG_NORMAL, 0,0,0       },
    { "triviaanswer",	do_triviaanswer,	POS_SLEEPING,0,LOG_NORMAL},
    { "triviatoggle",	do_triviatoggle,	POS_DEAD,	11, LOG_NORMAL},
    { "givetp",		do_givetp,		POS_DEAD,	11, LOG_ALWAYS},
    { "taketp",		do_taketp,		POS_DEAD,	11, LOG_ALWAYS},
    { "conceal",	do_conceal,		POS_STANDING,      3,  LOG_NORMAL, 8,DISC_VAMP_OBFU,5 },
    { "dub",        do_dub,			POS_STANDING,      3,  LOG_NORMAL, 8,DISC_VAMP_OBFU,4 },
    { "adrenorush", do_adrenorush, POS_FIGHTING, 3, LOG_NORMAL},
...
{ "llothsbless", do_llothsbless, POS_FIGHTING, 3, LOG_NORMAL, CLASS_DROW,0,0 },
	...
	/* No more luna Powers */
{"set",do_set,POS_DEAD,3,LOG_NORMAL},
    ...
    { "tick",		do_tick,       POS_DEAD,      10, LOG_ALWAYS, 0,0,0},
    ...
    { "demonwall",	do_demonwall,	POS_RESTING,   3,  LOG_NORMAL, 1, DISC_DAEM_ATTA, 3},
...
1,DISC_DAEM_CORR, 3 },
    ...
    { "leap",		do_leap,	POS_STANDING,  3,  LOG_NORMAL},
...
LOG_NORMAL,1,0,0 },
    ...
    { "screw",		do_screw,	POS_DEAD,	13, LOG_NORMAL,0,0,0},
    /* Start of OLC Shit. Hmm */
    { "hset",		do_hset,        POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    { "hedit",		do_hedit,       POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    { "hlist",		do_hlist,	POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    { "mcreate",	do_mcreate,	POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    { "ocreate",	do_ocreate,	POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    { "redit",		do_redit,	POS_DEAD,      13, LOG_ALWAYS, 0,0,0 },
    ...
    { "vset",		do_vset,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0 },
    ...
    { "Arcane",		do_change,	POS_STANDING,	 3,  LOG_NORMAL, 8,DISC_VAMP_PROT,3	},
    { "clanname",		do_clanname,POS_STANDING,	 9, LOG_ALWAYS, 0,0,0	},
...
/*start ninja section*/
    { "yashakin",	do_yashakin,	POS_RESTING,0,LOG_NORMAL},
    { "jusitori",	do_jusitori,	POS_RESTING,0,LOG_NORMAL},
    { "tsunaki",	do_tsunaki,	POS_RESTING,0,LOG_NORMAL},
    { "jeritsu",	do_jeritsu,	POS_RESTING,0,LOG_NORMAL},
...
/*start drow section */
    ...
    { "mortal",		do_mortal,	POS_FIGHTING,	 3,  LOG_NORMAL, 8},
    ...
    { "dokuyaku",	do_poison,	POS_STANDING,	 3,  LOG_NORMAL, 8,DISC_VAMP_SERP,3	},
    ...
    { "oscry",          do_oscry,       POS_STANDING,    3,  LOG_NORMAL},
    { "ofocus",         do_ofocus,      POS_STANDING,    3,  LOG_NORMAL},
    ...
    { "darkland",	do_darkland,	POS_STANDING,	 2,  LOG_NORMAL},
    ...
    /* Immortal commands.    */
    { "rd",		do_rd,		POS_DEAD, 10, LOG_NORMAL},
    { "fdwrite",	do_fdwrite,	POS_DEAD, 10, LOG_NORMAL},
    { "fdlist",		do_fdlist,	POS_DEAD, 10, LOG_NORMAL},
    { "setcontrol",	do_setcontrol,	POS_DEAD, 10, LOG_NORMAL},
    { "laymortal", do_makepreg, POS_DEAD, 10, LOG_ALWAYS},
    { "curseditem",	do_curseditem,	POS_DEAD, 10, LOG_NORMAL},
    { "eatmortal",	do_eatmortal,	POS_DEAD, 9, LOG_NORMAL},
    { "pdelete",	do_pdelete,	POS_DEAD, 10, LOG_ALWAYS},
    { "unrestore",	do_unrestore,	POS_DEAD, 9, LOG_NORMAL},
    { "beep",		do_beep,	POS_DEAD, 9, LOG_NORMAL},
    { "watch",		do_watch,	POS_DEAD, 10,LOG_NORMAL},
    { "immspar",	do_immspar,	POS_DEAD, 10,LOG_NORMAL},
//    { "immswitc",	do_huh,		POS_DEAD, 12, LOG_NORMAL},
//    { "immswitch",	do_immswitch,	POS_DEAD, 12, LOG_NORMAL},
    { "rename",		do_rename,	POS_DEAD, 9,LOG_NORMAL},
    { "multiple",	do_multiple,	POS_DEAD, 10, LOG_NORMAL},
    { "multicheck",	do_multicheck,	POS_DEAD, 7, LOG_NORMAL},
    { "randomload",	do_randomload,	POS_DEAD, 10,LOG_NORMAL},
    { "classconfig",	do_classconfig,	POS_DEAD, 10,LOG_NORMAL},
    { "autoclass",	do_autoclass,	POS_STANDING,2,LOG_NORMAL},
    { "loaddummy",	do_loaddummy,	POS_DEAD, 10,LOG_NORMAL},
    { "setimmpower",	do_setimmpower,	POS_DEAD, 12,LOG_ALWAYS},
    { "settitle",	do_settitle,	POS_DEAD, 10,LOG_NEVER},
    { "freevnums",	do_freevnums,	POS_DEAD, 10, LOG_NORMAL},
    { "daynight",	do_daynight,	POS_DEAD, 10, LOG_NORMAL},
    { "trust",		do_trust,	POS_DEAD,		 12,  LOG_ALWAYS, 0,0,0 },
    { "allow",		do_allow,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0	},
 ...
 //   { "clearpks",	do_clearpks, POS_DEAD, 2, LOG_NORMAL, 0, 0, 0},
    ...
    { "clearvamp",	do_clearvamp,POS_STANDING,	 10,  LOG_ALWAYS, 0,0,0	},
    { "hotboot",	do_hotboot, POS_DEAD,	10, LOG_ALWAYS, 0, 0, 0},
    { "copyover",	do_hotboot, POS_DEAD,	10, LOG_ALWAYS, 0, 0, 0},
    { "kinkboot",	do_hotboot, POS_DEAD,	10, LOG_ALWAYS, 0, 0, 0},
    { "pollboot",	do_pollboot,	POS_DEAD,	10, LOG_ALWAYS},
    { "create",		do_create,	POS_STANDING,	 10,  LOG_NORMAL, 0,0,0	},
    { "deny",		do_deny,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0	},
    { "disable",		do_disable,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0 },
    { "disconnect",	do_disconnect,POS_DEAD,		 9,  LOG_ALWAYS, 0,0,0	},
    ...
    { "paradox",		do_paradox,	POS_DEAD,		 9, LOG_ALWAYS, 0,0,0 },
    ...
    { "wizlock",		do_wizlock,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0	},
    { "watcher",		do_watcher,	POS_DEAD,	 	 9,  LOG_NEVER, 0,0,0	},
    { "force",		do_force,	POS_DEAD,	 	 9,  LOG_ALWAYS, 0,0,0	},
        { "jfade",	do_jfade,	POS_STANDING,    3,  LOG_NORMAL, 0,0,0 },
    ...
    { "mload",		do_mload,	POS_DEAD,	 	 10,  LOG_ALWAYS, 0,0,0	},
    { "undeny",         do_undeny,  POS_DEAD,      10,  LOG_ALWAYS, 0,0,0 },
    { "superset",	do_superset,	POS_DEAD,  12, LOG_ALWAYS, 0, 0, 0},
    { "mset",		do_mset,	POS_DEAD,  12,LOG_ALWAYS, 0,0,0	},
...
LOG_NORMAL,
1}, */
    { "decapitate",	do_decapitate,POS_STANDING,	 0,  LOG_NORMAL,
0,0,0 },
    { "sset",		do_sset,	POS_DEAD,		 7,  LOG_ALWAYS, 0,0,0 },
...
,        POS_DEAD,                11,
LOG_ALWAYS, 0,0,0       },
    { "font",           do_font,        POS_DEAD,                 10, 
LOG_NORMAL, 0,0,0       },
    { "bonus",          do_bonus,       POS_DEAD,                 10,
LOG_ALWAYS, 0,0,0       },
    { "questinfo",      do_questinfo,    POS_DEAD,                10,
LOG_NORMAL, 0,0,0       },
    { "mudc",           do_mudc,         POS_DEAD,                10,
LOG_NORMAL, 0,0,0       }, 
...
LOG_NORMAL, 0,0,0	},
    ...
    { "memory",		do_memory,	POS_DEAD,	 	 10,  LOG_NORMAL, 0,0,0	},
    ...
    { "slookup",		do_slookup,	POS_DEAD,	 	 10,  LOG_NORMAL, 0,0,0 },
    ...
    { "magecolor",      do_magecolor,		POS_STANDING,	9, LOG_ALWAYS, 0,0,0 },
    ...
    { "grow",		do_grow,	POS_RESTING,	2, LOG_NORMAL},
    ...
    { "newkill",	do_newkill,	POS_STANDING,	10, LOG_NORMAL},

    // Fluffies
    { "scribble",	do_scribble,	POS_RESTING,	4, LOG_NORMAL},
    { "pluck",		do_pluck,	POS_RESTING,	4, LOG_NORMAL},

    // druid
    {  "naturalize",	do_naturalize,	POS_SLEEPING,	2, LOG_NORMAL},
    ...
    {  "incubic",	do_incubic,	POS_FIGHTING,	2, LOG_NORMAL},
    ...
    { "slaiyth",	do_slaiyth,	POS_STANDING,	3, LOG_NORMAL,},
...
//0, 0 },
    ...
    { "naturetalk",	do_naturetalk,	POS_DEAD,	2, LOG_NORMAL, 0, 0, 0 },

    { "trample",	do_trample,	POS_DEAD,	2, LOG_NORMAL },
...
{ "amazonworship", do_amazonworship, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
    ...
    { "highstar",	do_highstar,	POS_RESTING,	3, LOG_NORMAL, 0, 0, 0},
    { "planeswalk",	do_planeswalk,	POS_STANDING,	3, LOG_NORMAL, 0, 0, 0},
...
const	struct	social_type	social_table [] =
{
	...
	"embrace",
	"Embrace whom?",
	"$n is so lonely, $s wants someone to embrace.",
	"Feeling lonely, you hold $N in a long embrace.",
	"Feeling lonely, $n holds $N in a long embrace.",
	"Feeling lonely, $n holds you in a long embrace.",
	"You embrace yourself. Poor, lonely soul=(",
	"$n embraces $mself. Poor, lonely soul=("
    },
	...
	"$n is looking for something to paint.",
	...
	"$n is a bit uncomfortable about the situation.",
	"You comfort $M.",
	"$n comforts $N.",
	"$n comforts you.",
	...
	"$n wants someone to cuddle with.",
	"You cuddle $M.",
	"$n cuddles $N.",
	"$n cuddles you.",
	...
	"$n feels like fondling somebody.",
	"You fondly fondle $M.",
	"$n fondly fondles $N.",
	...
	"french",
	"Kiss whom?",
	"$n feels like french kissing the world",
	...
	"$n gets jiggy",
	"You get jiggy with $N.",
	"$n gets jiggy with $N..",
	"$n gets jiggy with you. Ewwwww what's he doing with your top button?",
	"You jiggify yourself",
	"$n jiggifies $mself. Ewww, in public?"
    },
    ...
    {
	"scratch",
	"You scratch your head and go, 'Hmmmm.'",
	"$n scratches his head and goes, 'Hmmmm.'",
	"You scratch $S back.",
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    */ 
	...
	&&
(is_pure(cmd_table[cmd].name,find_kingdom(ch->kingdom)?find_kingdom(ch->kingdom)->Skills:" ") ||is_pure(cmd_table[cmd].name,ch->immpower) || cmd_table[cmd].level <= trust ))
	{
...
ch->pcdata->switchname : ch->short_descr, logline );
    ...
    {
	write_to_buffer( ch->desc->snoop_by, " ",    0 );
...
if (!check_xsocial(ch,command,argument))
	...
	{CHAR_DATA *vict; bool heal = TRUE;int dam;
	    ...
	    if (heal)
	    {
		act("&CYou feel better!#n",vict,0,0,TO_CHAR);
	    if (ch != vict)
		stc("&CYou cover them in love.#n\n\r", ch);
		act("&Cas $n licks $N, $M pain fades.",ch,0,vict,TO_NOTVICT);
	    }
	    if (!heal)
	    {
		act("&R$n's lick covers $N in gruesome slime.",ch,0,vict,TO_NOTVICT);
		stc("&RYour lick covers them in gruesome slime.\n\r",ch);
		act("&R$n's lick covers you in guesome slime.",ch,0,vict,TO_VICT);
	    }
	    WAIT_STATE(ch, ch->generation < 5 ? 5 : ch->generation);
...
if (IS_GOLEM(ch) && IS_INFORM(ch,GOLEM_RUBY))
{
 if (cmd_table[cmd].position > POS_SLEEPING) {
  if (!(ch->moves & IN_RUBY)) {
    act("&C$n melts and reforms into $t.#n", ch, ch->name, 0, TO_ROOM);
    stc("&RYour quick actions make you hot, forcing you to melt and reform.#n\n\r", ch);
...
else
{
    if ( arg[0] == '\0' )
    {
	sprintf(log_buf,"&G[&RGSocial&G] &C%s",
social_table[cmd].others_no_arg);
	gsact( log_buf, ch, NULL, victim, TO_ROOM ,CHANNEL_GSOCIAL   );
	sprintf(log_buf,"&G[&RGSocial&G] &C%s",
social_table[cmd].char_no_arg);
	gsact( log_buf, ch, NULL, victim, TO_CHAR  ,CHANNEL_GSOCIAL  );
    }
...
social_table[cmd].others_found);
	gsact( log_buf, ch, NULL, victim, TO_NOTVICT ,CHANNEL_GSOCIAL   );
	sprintf(log_buf,"&G[&RGSocial&G] &C%s",
social_table[cmd].char_found);
	gsact( log_buf, ch, NULL, victim, TO_CHAR ,CHANNEL_GSOCIAL   );
	sprintf(log_buf,"&G[&RGSocial&G] &C%s",
social_table[cmd].vict_found);
	gsact( log_buf, ch, NULL, victim, TO_VICT ,CHANNEL_GSOCIAL   );
    }
...
/*	if (xsocial_table[cmd].gender == SEX_MALE && ch->sex != SEX_MALE)
	...
	else */if ((!IS_NPC(ch)&&!IS_NPC(victim))&&((partner = victim->pcdata->partner) == NULL || partner != ch))
	{
